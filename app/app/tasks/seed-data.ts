...
export const tasksSeedData = {
  tasks: [
    ...
    // Additional tasks for scrolling test
    {
      id: "TASK-013",
      leadId: "LEAD-005",
      title: "Qualify new inbound lead",
      description: "Received inquiry from Zillow, need to qualify",
      type: "call" as const,
      priority: "high" as const,
      status: "open" as const,
      assigneeId: "USER-001",
      ...
      linkedEntity: {
        ...
        address: "555 Palm Way, Glendale, AZ"
      },
      createdAt: hoursAgo(0.5),
      updatedAt: hoursAgo(0.5),
      tags: ["inbound", "zillow"]
    },
    {
      ...
      linkedEntity: {
        type: "deal" as const,
        id: "DEAL-007",
        name: "888 Mountain View Deal",
        address: "888 Mountain View Rd, Peoria, AZ"
      },
      createdAt: hoursAgo(1),
      updatedAt: hoursAgo(1),
      tags: ["pof", "buyer"]
    },
    {
      id: "TASK-015",
      leadId: "LEAD-006",
      title: "Send initial offer letter",
      type: "follow-up" as const,
      priority: "high" as const,
      status: "open" as const,
      assigneeId: "USER-002",
      ...
      linkedEntity: {
        ...
        id: "LEAD-006",
        name: "William Chen",
        address: "123 Desert Rose Ln, Scottsdale, AZ"
      },
      createdAt: hoursAgo(2),
      updatedAt: hoursAgo(2),
      tags: ["offer"]
    },
    {
      id: "TASK-016",
      dealId: "DEAL-008",
      title: "Schedule closing with title company",
      type: "generic" as const,
      priority: "high" as const,
      status: "in-progress" as const,
      assigneeId: "USER-005",
      ...
      linkedEntity: {
        type: "deal" as const,
        id: "DEAL-008",
        name: "777 Sunset Blvd Deal",
        address: "777 Sunset Blvd, Phoenix, AZ"
      },
      createdAt: daysAgo(2),
      updatedAt: hoursAgo(4),
      tags: ["closing"]
    },
    {
      id: "TASK-017",
      leadId: "LEAD-007",
      title: "Drive by property for condition check",
      type: "inspection" as const,
      priority: "normal" as const,
      status: "open" as const,
      assigneeId: "USER-001",
      ...
      linkedEntity: {
        ...
        id: "LEAD-007",
        name: "Maria Santos",
        address: "999 Cactus Ave, Tempe, AZ"
      },
    ...
    },
    {
      id: "TASK-018",
      dealId: "DEAL-009",
      title: "Request repair estimates from contractor",
      type: "underwriting" as const,
      priority: "high" as const,
      status: "open" as const,
      assigneeId: "USER-003",
      ...
      linkedEntity: {
        type: "deal" as const,
        id: "DEAL-009",
        name: "456 Adobe Way Deal",
        address: "456 Adobe Way, Mesa, AZ"
      },
      createdAt: hoursAgo(3),
      updatedAt: hoursAgo(3),
      tags: ["repairs", "contractor"]
    },
    {
      id: "TASK-019",
      title: "Review marketing materials for dispo",
      type: "dispo" as const,
      priority: "normal" as const,
      status: "open" as const,
      assigneeId: "USER-004",
    ...
    },
    {
      id: "TASK-020",
      leadId: "LEAD-008",
      title: "Follow up on voicemail - motivated seller",
      type: "call" as const,
      priority: "urgent" as const,
      status: "open" as const,
      assigneeId: "USER-002",
      ...
      linkedEntity: {
        ...
        id: "LEAD-008",
        name: "Robert Kim",
        address: "321 Saguaro Dr, Gilbert, AZ"
      },
      createdAt: hoursAgo(0.25),
      updatedAt: hoursAgo(0.25),
      tags: ["voicemail", "motivated"]
    },
    {
      id: "TASK-021",
      dealId: "DEAL-010",
      title: "Send assignment contract to buyer",
      type: "dispo" as const,
      priority: "high" as const,
      status: "open" as const,
      assigneeId: "USER-004",
      ...
      linkedEntity: {
        type: "deal" as const,
        id: "DEAL-010",
        name: "654 Ironwood Ct Deal",
        address: "654 Ironwood Ct, Chandler, AZ"
      },
      createdAt: hoursAgo(2),
      updatedAt: hoursAgo(2),
      tags: ["assignment"]
    ...
    {
      id: "TASK-022",
      title: "Update skip trace data for leads",
      type: "generic" as const,
      priority: "low" as const,
      status: "open" as const,
      assigneeId: "USER-005",
    ...
    },
    {
      ...
      linkedEntity: {
        type: "deal" as const,
        id: "DEAL-011",
        name: "987 Palo Verde Deal",
        address: "987 Palo Verde St, Phoenix, AZ"
      },
      createdAt: hoursAgo(1),
      updatedAt: hoursAgo(1),
      tags: ["emd", "escrow"]
    },
    {
      id: "TASK-024",
      leadId: "LEAD-009",
      title: "Research property liens and encumbrances",
      type: "underwriting" as const,
      priority: "normal" as const,
      status: "open" as const,
      assigneeId: "USER-003",
      ...
      linkedEntity: {
        ...
        id: "LEAD-009",
        name: "James Wilson",
        address: "741 Mesquite Ln, Surprise, AZ"
      },
      createdAt: hoursAgo(4),
      updatedAt: hoursAgo(4),
      tags: ["title-search", "liens"]
    },
    {
      id: "TASK-025",
      title: "Send weekly pipeline report",
      type: "generic" as const,
      priority: "normal" as const,
      status: "open" as const,
      assigneeId: "USER-006",
    ...
    },
    {
      id: "TASK-026",
      dealId: "DEAL-012",
      title: "Coordinate with buyer's lender",
      type: "dispo" as const,
      priority: "high" as const,
      status: "in-progress" as const,
      assigneeId: "USER-004",
      ...
      linkedEntity: {
        type: "deal" as const,
        id: "DEAL-012",
        name: "852 Yucca Way Deal",
        address: "852 Yucca Way, Scottsdale, AZ"
      },
      createdAt: daysAgo(3),
      updatedAt: hoursAgo(2),
      tags: ["lender", "financing"]
    },
    {
      id: "TASK-027",
      leadId: "LEAD-010",
      title: "Text seller about viewing appointment",
      type: "follow-up" as const,
      priority: "normal" as const,
      status: "open" as const,
      assigneeId: "USER-001",
      ...
      linkedEntity: {
        ...
        address: "369 Ocotillo Dr, Mesa, AZ"
      },
      createdAt: hoursAgo(1),
      updatedAt: hoursAgo(1),
