  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "text-gray-700 data-[state=active]:bg-white data-[state=active]:text-gray-900 data-[state=active]:shadow-sm",
        "dark:text-gray-400 dark:data-[state=active]:bg-zinc-700 dark:data-[state=active]:text-white",
        className
      )}
      {...props}
    />
