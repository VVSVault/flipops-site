...
const OLD_WORKFLOW_ID = 'XQlp1zcll7MSWHB6';

async function createNoLoopWorkflow() {
  ...
  try {
    ...
    console.log('📋 Creating FINAL Data Refresh workflow (no loop nodes)...\n');
